...
To do this is I settled upon https://asciidoc.org/[AsciiDoc] to mark up the text of the paper. I chose AsciiDoc over http://daringfireball.net/projects/markdown/[Markdown] because of the depth of features and availability of conversion tools.
...
KelsoPaper.html:: XHTML file generated from KelsoPaper.txt using the command `a2x -v -f xhtml KelsoPaper.txt`. You can view the result https://choosypopcorn.github.io/classical-binary/KelsoPaper.html[in your browser from the repo].
